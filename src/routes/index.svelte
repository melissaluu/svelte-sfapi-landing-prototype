...
<section class="hero">
	...
	<div class="row-span-2 col-start-3 row-start-1 col-span-2">
		<img src="./vacation-town-stroll.jpg" class="rotate-12 rounded-md border-4 border-white m-2 w-80 shadow-sm" width=275 alt="">
	</div>
	<div class="header">
		...
		<div class="mt-6">
			<a href="/" class="px-6 py-3 rounded-md bg-orange-500 shadow-md text-white">Shop for your vacation</a>
		</div>
	</div>
</section>
...
<section class="mt-7 px-8 py-4">
	...
	{:else if $collection.error} 
		Vacation on hold for a little bit longer...
	{:else} -->
	<div>
	...
	<div class="mt-12 flex align-middle justify-center">
		<button on:click={buyCollection} class="px-6 py-4 bg-green-800 text-white rounded-md uppercase tracking-wide">Buy vacation essentials now</button>
	</div>
	<!-- {/if} -->
</section>
...
<style>
.hero {
	@apply grid  bg-[url('./tropical-beach-sunrise.jpg')] bg-cover min-w-min;
